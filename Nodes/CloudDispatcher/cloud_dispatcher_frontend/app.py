"""CloudDispatcher FE — approve drafts, watch runs, open the pull request.
...
log = logging.getLogger("cloud_dispatcher.fe")
...
_LIVE: dict[str, "CloudDispatcherFE"] = {}
...
def main() -> None:
    raise SystemExit(
        "CloudDispatcher FE is canvas-only. Drop it from the MegaDesk Catalog."
    )
