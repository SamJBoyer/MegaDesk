...
- `agent-{guid}.md` — one MachineFactory sandbox run. Streamed SDK progress (tool calls, thinking, assistant text) so a stuck agent is visible without opening Docker.
