...
Nodes are discovered on startup by MegaDesk from the entry points and
...
gui executable instruction telling MegaDesk how to launch the Dear PyGui as a subnode
inside the canvas. MegaDesk then pings the supervisor with the node name to indicate
